...
image:clojars-0.2.3.svg[link=https://clojars.org/gnl/ghostwheel] image:https://cljdoc.xyz/badge/gnl/ghostwheel[link=https://cljdoc.xyz/jump/release/gnl/ghostwheel] image:license.svg[link=https://choosealicense.com/licenses/epl-2.0] image:https://circleci.com/gh/gnl/ghostwheel.svg?style=shield["CircleCI", link="https://circleci.com/gh/gnl/ghostwheel"]
...
. Make sure your Clojure version is at least 1.9.0 and add the artifact to your project dependencies:
+
...
+
Ghostwheel's behaviour is determined individually for each function by merging the configuration maps – default config -> global/compiler config -> namespace metadata -> function metadata. The more intrusive and performance-wise expensive functionality is disabled by default to avoid any nasty surprises.
+
